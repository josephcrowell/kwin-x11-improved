...
void MoveResizeWindowTest::testMove()
{
    ...
    QCOMPARE(window->geometryRestore(), BoxF());
    ...
    QCOMPARE(window->frameGeometry(), BoxF(16, 32, 100, 50));
...
void MoveResizeWindowTest::testResize()
{
    ...
    QCOMPARE(window->frameGeometry(), BoxF(0, 0, 108, 50));
    QCOMPARE(interactiveMoveResizeSteppedSpy.count(), 1);
    ...
    QVERIFY(frameGeometryChangedSpy.wait());
    QCOMPARE(window->frameGeometry(), BoxF(0, 0, 108, 58));
    QCOMPARE(interactiveMoveResizeSteppedSpy.count(), 2);
...
void MoveResizeWindowTest::testPackTo_data()
{
    ...
    QTest::newRow("left") << QStringLiteral("slotWindowMoveLeft") << BoxF(0, 487, 100, 50);
    QTest::newRow("up") << QStringLiteral("slotWindowMoveUp") << BoxF(590, 0, 100, 50);
    QTest::newRow("right") << QStringLiteral("slotWindowMoveRight") << BoxF(1180, 487, 100, 50);
    QTest::newRow("down") << QStringLiteral("slotWindowMoveDown") << BoxF(590, 974, 100, 50);
}
...
void MoveResizeWindowTest::testPackTo()
{
    ...
    workspace()->placement()->placeCentered(window, BoxF(0, 0, 1280, 1024));
    QCOMPARE(window->frameGeometry(), BoxF(590, 487, 100, 50));
...
void MoveResizeWindowTest::testPackAgainstClient_data()
{
    ...
    QTest::newRow("left") << QStringLiteral("slotWindowMoveLeft") << BoxF(10, 487, 100, 50);
    QTest::newRow("up") << QStringLiteral("slotWindowMoveUp") << BoxF(590, 10, 100, 50);
    QTest::newRow("right") << QStringLiteral("slotWindowMoveRight") << BoxF(1170, 487, 100, 50);
    QTest::newRow("down") << QStringLiteral("slotWindowMoveDown") << BoxF(590, 964, 100, 50);
}
...
void MoveResizeWindowTest::testPackAgainstClient()
{
    ...
    auto renderWindow = [](KWayland::Client::Surface *surface, const QString &methodCall, const BoxF &expectedGeometry) {
        // let's render
        ...
        // let's place it centered
        workspace()->placement()->placeCentered(window, BoxF(0, 0, 1280, 1024));
        QCOMPARE(window->frameGeometry(), BoxF(635, 507, 10, 10));
        QMetaObject::invokeMethod(workspace(), methodCall.toLocal8Bit().constData());
        QCOMPARE(window->frameGeometry(), expectedGeometry);
    };
    renderWindow(surface1.get(), QStringLiteral("slotWindowMoveLeft"), BoxF(0, 507, 10, 10));
    renderWindow(surface2.get(), QStringLiteral("slotWindowMoveUp"), BoxF(635, 0, 10, 10));
    renderWindow(surface3.get(), QStringLiteral("slotWindowMoveRight"), BoxF(1270, 507, 10, 10));
    renderWindow(surface4.get(), QStringLiteral("slotWindowMoveDown"), BoxF(635, 1014, 10, 10));
...
void MoveResizeWindowTest::testGrowShrink_data()
{
    ...
    QTest::newRow("grow vertical") << QStringLiteral("slotWindowExpandVertical") << BoxF(590, 487, 100, 537);
    QTest::newRow("grow horizontal") << QStringLiteral("slotWindowExpandHorizontal") << BoxF(590, 487, 690, 50);
    QTest::newRow("shrink vertical") << QStringLiteral("slotWindowShrinkVertical") << BoxF(590, 487, 100, 23);
    QTest::newRow("shrink horizontal") << QStringLiteral("slotWindowShrinkHorizontal") << BoxF(590, 487, 40, 50);
}
...
void MoveResizeWindowTest::testClientSideMove()
{
    ...
    const BoxF startGeometry = window->frameGeometry();
...
{
    QTest::addColumn<BoxF>("windowRect");
    QTest::addColumn<BoxF>("keyboardRect");
    QTest::addColumn<BoxF>("resizedWindowRect");

    QTest::newRow("standard") << BoxF(100, 300, 500, 800) << BoxF(0, 100, 1280, 500) << BoxF(100, 0, 500, 100);
    QTest::newRow("same size") << BoxF(100, 300, 500, 500) << BoxF(0, 600, 1280, 400) << BoxF(100, 100, 500, 500);
    QTest::newRow("smaller width") << BoxF(100, 300, 500, 800) << BoxF(300, 100, 100, 500) << BoxF(100, 0, 500, 100);
    QTest::newRow("no height change") << BoxF(100, 300, 500, 500) << BoxF(0, 900, 1280, 124) << BoxF(100, 300, 500, 500);
    QTest::newRow("no width change") << BoxF(100, 300, 500, 500) << BoxF(0, 400, 100, 500) << BoxF(100, 300, 500, 500);
}
...
void MoveResizeWindowTest::testResizeForVirtualKeyboard()
{
    ...
    QFETCH(BoxF, windowRect);
    QFETCH(BoxF, keyboardRect);
    QFETCH(BoxF, resizedWindowRect);
    ...
    window->setVirtualKeyboardGeometry(BoxF());
...
void MoveResizeWindowTest::testResizeForVirtualKeyboardWithMaximize()
{
    ...
    QCOMPARE(window->frameGeometry(), BoxF(100, 300, 500, 800));
    window->setVirtualKeyboardGeometry(BoxF(0, 100, 1280, 500));
    QVERIFY(surfaceConfigureRequestedSpy.wait());
    ...
    Test::render(surface.get(), toplevelConfigureRequestedSpy.last().first().toSize(), Qt::blue);
    QVERIFY(frameGeometryChangedSpy.wait());
    QCOMPARE(window->frameGeometry(), BoxF(100, 0, 500, 100));
    ...
    Test::render(surface.get(), toplevelConfigureRequestedSpy.last().first().toSize(), Qt::blue);
    QVERIFY(frameGeometryChangedSpy.wait());
    QCOMPARE(window->frameGeometry(), BoxF(0, 0, 1280, 1024));
...
void MoveResizeWindowTest::testCancelInteractiveMoveResize()
{
    ...
    const BoxF geometry = window->moveResizeGeometry();
    const BoxF geometryRestore = window->geometryRestore();
