...
void TestXdgShellWindow::testWindowOutputs()
{
    ...
    window->moveResize(BoxF(QPoint(1250, 100), size));
    QVERIFY(outputEnteredSpy.wait());
    ...
    window->moveResize(BoxF(QPoint(1400, 100), size));
...
void TestXdgShellWindow::testFullscreen()
{
    ...
    QCOMPARE(window->frameGeometry(), BoxF(QPoint(0, 0), window->output()->geometry().size()));
...
void TestXdgShellWindow::testSendFullScreenWindowToAnotherOutput()
{
    ...
    QCOMPARE(window->frameGeometry(), BoxF(10, 20, 100, 50));
    ...
    QCOMPARE(window->fullscreenGeometryRestore(), BoxF(10, 20, 100, 50));
    QCOMPARE(window->output(), outputs[0]);
    ...
    QCOMPARE(window->fullscreenGeometryRestore(), BoxF(1280 + 10, 20, 100, 50));
...
void TestXdgShellWindow::testSendMaximizedWindowToAnotherOutput()
{
    ...
    QCOMPARE(window->maximizeMode(), MaximizeFull);
    QCOMPARE(window->frameGeometry(), BoxF(0, 0, 1280, 1024));
    QCOMPARE(window->geometryRestore(), BoxF(10, 20, 100, 50));
    QCOMPARE(window->output(), outputs[0]);
    ...
    QCOMPARE(window->maximizeMode(), MaximizeFull);
    QCOMPARE(window->frameGeometry(), BoxF(1280, 0, 1280, 1024));
    QCOMPARE(window->geometryRestore(), BoxF(1280 + 10, 20, 100, 50));
    QCOMPARE(window->output(), outputs[1]);
}
...
void TestXdgShellWindow::testInteractiveMoveUnmaximizeFull()
{
    ...
    const BoxF maximizedGeometry = window->frameGeometry();
