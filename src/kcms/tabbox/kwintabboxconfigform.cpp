    ...
    , ui(new Ui::KWinTabBoxConfigForm)
{
    ...
    auto initShortcutWidget = [this](KKeySequenceWidget *primary, KKeySequenceWidget *alternate, const QString &name) {
        ...
        connect(primary, &KKeySequenceWidget::keySequenceChanged, this, [this, name](const QKeySequence &seq) { // TODO: we need a recorded() signal
        ...
        connect(alternate, &KKeySequenceWidget::keySequenceChanged, this, [this, name](const QKeySequence &seq) { // TODO: we need a recorded() signal
