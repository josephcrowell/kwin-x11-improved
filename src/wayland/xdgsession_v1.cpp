...
protected:
    ...
    void xdg_session_v1_remove_toplevel(Resource *resource, const QString &toplevel_id) override;
};
...
void XdgApplicationSessionV1InterfacePrivate::xdg_session_v1_remove_toplevel(Resource *resource, const QString &toplevel_id)
{
    Q_UNUSED(resource)
...
void XdgToplevelSessionV1Interface::sendRestored()
{
    ...
    // this API is dumb, the client knows the toplevel
